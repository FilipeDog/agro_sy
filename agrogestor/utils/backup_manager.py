...
class BackupManager:
    ...
    def __init__(self, db_path=None):
        if db_path is None:
            ...
            self.db_path = os.path.join(base_dir, 'agrogestor', 'core', 'database', 'gado.db')
            self.backup_dir = os.path.join(base_dir, 'data', 'backups')
        else:
            self.db_path = db_path
            # Se um caminho customizado for fornecido, usar o diretório de backups na raiz do projeto
            base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
            self.backup_dir = os.path.join(base_dir, 'data', 'backups')
